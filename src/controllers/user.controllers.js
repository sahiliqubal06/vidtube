...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    throw new ApiError(400, "All fields are required", "fullname is required");
  }
...
const logoutUser = asyncHandler(async (req, res) => {
  ...
  return res
    ...
    .json(new ApiResponse(200), {}, "User loggedd out successfully");
});
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      "Something went wrong whie refreshing access token"
    );
  }
});
